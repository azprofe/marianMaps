...
using System.Collections;
...
#endif
   {
      ...
      public Font fontVariables = DefaultFont;
#if !PocketPC
      ...
      public virtual void OnRender(Graphics g)
      {
      	...
      	altura = g.MeasureString(Marker.Variable1, fontVariables).ToSize().Width+ g.MeasureString(Marker.ToolTipText, Font).ToSize().Width;
         ...
         g.DrawString(Marker.Variable1, fontVariables , Foreground, rect, Format);
      }
